...
Python 2.7 is in legacy support mode, with the last release supporting being 1.7; see `here <https://eliot.readthedocs.io/en/stable/python2.html>`_ for details.
